...
<div class="d-flex flex-column flex-shrink-0 side-bar-wrapper">
    <ul class="nav nav-pills nav-flush flex-column mb-auto text-center">
        <li>
            <a href="{{ route('videos.index') }}" class="nav-link py-3 border-bottom" title="Home" data-bs-toggle="tooltip" data-bs-placement="right">
        ...
        <li>
            <a href="{{ route('user.subscriptions', Auth::user()) }}" class="nav-link py-3 border-bottom" title="Subscription" data-bs-toggle="tooltip" data-bs-placement="right">
